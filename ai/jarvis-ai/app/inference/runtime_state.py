...
def set_jarvis_state(state):
    ...
    if JARVIS_STATE == state:

        return False

    JARVIS_STATE = state

    get_runtime().jarvis_state = state
...
def get_jarvis_state():

    return get_runtime().jarvis_state
